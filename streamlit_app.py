...
try:
  ...
  if not fruit_choice:
    streamlit.error("Please select a fruit to get that information.")
  else:
...
#don't run anything pas here while we troubleshooot
#streamlit.stop()
...
#Allow the end use to add fruit to the list
...
if streamlit.button('Get Fruit Listi'):
      my_cnx = snowflake.connector.connect(**streamlit.secrets["snowflake"])
